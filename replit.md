...
- **Legal Contracts Library:** Interactive menu in HR Bot providing access to 38 legal contract templates across 2 company entities: Бест Брендс (19 contracts) and Торговий Дім АВ (19 contracts). Organized by category (Marketing, Logistics, Distribution, Supply/Procurement, Additional Agreements). Documents served via `/static/legal_contracts/` endpoint and delivered directly to users via Telegram sendDocument API.
