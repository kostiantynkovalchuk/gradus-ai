...
- **Backend Monetization System:** Email-based user management with subscription tiers (free: 5 questions/day, standard: $7/mo, premium: $10/mo). DB-backed rate limiting via `maya_users` table. LiqPay payment integration for checkout and webhooks. Daily subscription expiry checker at 4:00 AM. Tables: `maya_users`, `maya_subscriptions`, `maya_query_log`.
