...
def expand_brand_query(user_message: str) -> str:
    ...
    brand_expansions = {
        ...
        # Legal/licensing queries
        'ліцензія': 'ліцензія алкоголь ліцензування license дпс рро прро вартість штрафи 2026',
        'ліцензування': 'ліцензія алкоголь ліцензування license дпс рро прро вартість 2026',
        'license': 'ліцензія алкоголь ліцензування license дпс рро прро вартість 2026',
        'дозвіл на алкоголь': 'ліцензія алкоголь ліцензування license дпс рро прро вартість',
        'рро': 'ліцензія алкоголь рро прро касовий апарат дпс',
        'прро': 'ліцензія алкоголь рро прро касовий апарат дпс',
    }
