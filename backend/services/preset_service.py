...
class PresetService:
    def __init__(self):
        ...
        self._keywords_map = {
            ...
            # cocktail trends / summer menu — Ukrainian (value = exact question_pattern in DB)
            ("коктейл", "тренд"): r"які коктейлі в тренд|тренди коктейл|літн[еє]? меню|коктейлі для меню|тренди напоїв",
            ("тренди", "коктейл"): r"які коктейлі в тренд|тренди коктейл|літн[еє]? меню|коктейлі для меню|тренди напоїв",
            ("літн", "меню"): r"які коктейлі в тренд|тренди коктейл|літн[еє]? меню|коктейлі для меню|тренди напоїв",
            ("коктейлі", "для", "меню"): r"які коктейлі в тренд|тренди коктейл|літн[еє]? меню|коктейлі для меню|тренди напоїв",
            # cocktail trends / summer menu — Russian (value = exact question_pattern in DB)
            ("коктейли", "тренде"): r"какие коктейли в тренде|летнее меню|тренды коктейлей|какие напитки в тренде",
            ("летнее", "меню"): r"какие коктейли в тренде|летнее меню|тренды коктейлей|какие напитки в тренде",
            ("тренды", "коктейлей"): r"какие коктейли в тренде|летнее меню|тренды коктейлей|какие напитки в тренде",
