...
class ContentScheduler:
    ...
    def scrape_facebook_sources_task(self):
        ...
        try:
            ...
            facebook_sources = ['delo_ua', 'restorator_ua', 'just_drinks', 'modern_restaurant_management', 'spirits_business_reviews']
...
🕐 {datetime.utcnow().strftime('%H:%M, %d %b %Y')}"""
    ...
    def check_and_run_missed_scraping(self):
        ...
        try:
            ...
            try:
                ...
                facebook_sources = ['Delo.ua', 'HoReCa-Україна', 'Just Drinks', 'Modern Restaurant Management', 'The Spirits Business Reviews']
    ...
    def start(self):
        ...
        # LinkedIn weekly news digest — Monday 07:00 UTC (09:00 Kyiv)
        self.scheduler.add_job(
