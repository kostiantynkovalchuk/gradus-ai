...
async def help_cmd(message: Message):
    help_text = (
        "🔍 *Як шукати в СОЛОМОН:*\n\n"
        "*Звичайний пошук:*\n"
        "- скасування ППР нереальність операцій\n"
        "- АМКУ антиконкурентні дії господарські\n\n"
        "*З фільтрами часу:*\n"
        "- стягнення збитків цивільне за 2025 рік\n"
        "- банкрутство господарське 2024-2025\n\n"
        "*По статті закону:*\n"
        "- стаття 324 КАС порушення процедури\n"
        "- ст\\. 185 КК України 2025\n"
        "- стаття 42 ГК стягнення збитків\n\n"
        "*По судді:*\n"
        "- практика судді Блажівської\n"
        "- рішення Тітова за 2025 рік\n\n"
        "*По номеру справи:*\n"
        "- справа 910/12568/24\n"
        "- знайди 380/25114/23\n\n"
        "*Кількість результатів:*\n"
        "- покажи 10 рішень про банкрутство\n"
        "- дай 3 приклади оскарження ППР\n\n"
