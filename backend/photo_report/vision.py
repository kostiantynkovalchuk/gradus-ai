...
HELSINKI (Хельсінкі) — НАША — ЧАСТО ПРОПУСКАЄТЬСЯ:
  КЛЮЧОВА ОЗНАКА: Характерна СИНЯ пляшка або синя етикетка
  Напис "HELSINKI" латинськими літерами
  Виділяється як синє серед зеленого (GreenDay) та прозорого (Ukrainka)
  Зазвичай 1–3 пляшки, не великі групи
...
_FOCUSED_PROMPTS = {
    ...
    "vodka": (
        ...
        "та HELSINKI — СИНІ пляшки. Обидва бренди часто пропускаються. "
