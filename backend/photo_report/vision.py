...
ПРАВИЛА ТОЧНОГО ПІДРАХУНКУ:
- Рахуй КОЖЕН фейсинг на КОЖНОМУ ряду. НЕ зупиняйся після 2–3 рядів.
- Малі пляшки (0.1л, 0.2л, 0.375л) — теж фейсинги. НЕ пропускай міні-пляшки.
- Ukrainka має багато SKU — ВСІ рахуються разом:
    Traditional (біла етикетка), Crystal (срібна/діамантова),
    настоянки/tinctures (червона ягода, зелена трава, чорна смородина) — всі це Ukrainka.
- GreenDay є різних розмірів на різних полицях: 0.5л зверху, 0.2л і 0.1л знизу. Рахуй ВСІ.
- Нижні ряди (3–6) часто недооцінюють — пляшки менші або під кутом. Дивись УВАЖНО.
- Після підрахунку — перевір: сума фейсингів по рядах = сумі по брендах? Якщо ні — перерахуй.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
КРОК 11 — ФІНАЛЬНА ПЕРЕВІРКА ПІДРАХУНКУ (ОБОВ'ЯЗКОВО ПЕРЕД JSON)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Перед поверненням JSON виконай перевірку для горілки:
  1. Підсумуй greenday_facings з УСІХ рядів shelf_scan
  2. Підсумуй ukrainka_facings з УСІХ рядів shelf_scan
  3. Підсумуй helsinki_facings з УСІХ рядів shelf_scan
  4. Якщо сума по рядах відрізняється від твоїх reported facings — використай суму по рядах (вона точніша).
  5. total_vodka_facings = сума ВСІХ горілок (наших + конкурентів) з УСІХ рядів.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
КРОК 12 — ФОРМАТ ВІДПОВІДІ (ТІЛЬКИ ФАКТИ)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
